...
<div class="modal fade" id="uploadNoteModal" tabindex="-1" aria-labelledby="uploadNoteModalLabel" aria-hidden="true">
    <form method="POST">
        <input type="hidden" name="suggest_school" value="1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="uploadNoteModalLabel">Suggest a new School</h1>
